...
interface CreateLeagueModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (league: { name: string; description: string; active: boolean }) => void;
}

export default function CreateLeagueModal({ isOpen, onClose, onSave }: CreateLeagueModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-gray-800 p-6 rounded-lg w-full max-w-md">
        <h2 className="text-xl font-bold mb-4 text-white">Create League</h2>
